...
namespace Practice_Linq
{
    public class Program
    {
        ...
        static void Query2(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game =>
                    ...
                    (game.Home_team.Equals("Italy") || game.Away_team.Equals("Italy")) &&
                    game.Date.Year >= 2020);  // Корегуємо запит !!!// Корегуємо запит !!!
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game =>
                    ...
                    game.Date.Year == 2021);// Корегуємо запит !!!
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game =>
                    game.Tournament.Equals("UEFA Euro qualification") &&
                    (game.City.Equals("Kyiv") || game.City.Equals("Kharkiv")) &&
                    game.Home_team.Equals("Ukraine") &&
                    game.Home_score > game.Away_score);  // Корегуємо запит !!!
        ...
        static void Query6(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game => game.Tournament.Equals("FIFA World Cup"))
                .TakeLast(8)
                .OrderByDescending(p => p.Date);  // Корегуємо запит !!!
        ...
        static void Query8(List<FootballGame> games)
        {
            ...
            var selectedGames = games
               .Where(game =>
                   game.Tournament.Equals("UEFA Euro") &&
                   game.Date.Year == 2012 &&
                   game.Country.Equals("Ukraine"))
               .Select(game => new
               {
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game =>
                    game.Tournament.Equals("UEFA Nations League") &&
                    game.Date.Year == 2023)
                .Select(game => new
                {
                    MatchYear = game.Date.Year,
                    Game = $"{game.Home_team} - {game.Away_team}",
                    Result = MatchResult(game)
                })
                .ToList();   // Корегуємо запит !!!
            ...
            // див. приклад як має бути виведено:
            static string MatchResult(FootballGame game)
            {
        ...
        static void Query10(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game =>
                    game.Tournament.Equals("Gold Cup") &&
                    game.Date.Year == 2023 &&
                    game.Date.Month == 7)
                .Skip(4)
